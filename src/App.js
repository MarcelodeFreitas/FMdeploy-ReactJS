...
import {
  RoutesPrivate,
  RoutesNotPrivate,
  RoutesPrivateShareable,
} from "./components/Routes/Private/Private";
...
import RunHistory from "./components/pages/App/RunHistory";
...
import ManageUsers from "./components/pages/App/ManageUsers";
        ...
        <BrowserRouter>
          <StoreProvider>
            <Switch>
              ...
              <RoutesPrivate path="/run-history" exact component={RunHistory} />
              <RoutesPrivateShareable
                path="/runs/:projectId"
                component={RunLinkable}
              />
