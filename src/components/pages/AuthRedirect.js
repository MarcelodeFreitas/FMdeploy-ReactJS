      ...
      <div>
        <div className="auth-redirect-header">
          <div>
            ...
            {props.location.state.location.pathname === "user-settings" ? (
              <div
                style={{ fontSize: "14px", marginTop: "5px", display: "flex" }}
              >
                Use updated fields.
              </div>
            ) : (
        ...
        <Stack sx={{ width: "270px", marginTop: "10px" }} spacing={2}>
          ...
          {props.location.state.message && (
            <Alert severity={props.location.state.severity}>
              {props.location.state.message}
            </Alert>
          )}
        </Stack>
        ...
        <div style={{ marginTop: "10px" }}>
          ...
          <div>
            <FormControl
              style={{ paddingBottom: "10px", width: "270px" }}
              variant="outlined"
              size="medium"
            >
            ...
            <FormControl
              sx={{ paddingBottom: "10px", width: "270px" }}
              variant="outlined"
              size="medium"
            >
          ...
          <Box>
            ...
            <Button
              variant="contained"
              sx={{ bgColor: "#0385B0", width: "270px", height: "50px" }}
