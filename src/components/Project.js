        ...
        >
          ...
          <div style={{ paddingTop: 20, paddingLeft: 20, paddingRight: 20 }}>
            <Typography variant="body1">
              This option will delete this project incuding python script, model
              files, input files and output files.
            </Typography>
          </div>
